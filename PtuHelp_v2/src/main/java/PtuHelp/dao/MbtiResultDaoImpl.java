...
public class MbtiResultDaoImpl implements MbtiResultDao {
	...
	@Override
    public String getMbtiResultByUserId(int userId) {
        return sqlSession.selectOne(namespace + ".getMbtiResultByUserId", userId);
    }

	@Override
	public void insertOrUpdateResult(MbtiResult mbtiResult) {
		sqlSession.insert(namespace + ".insertOrUpdateResult", mbtiResult);
